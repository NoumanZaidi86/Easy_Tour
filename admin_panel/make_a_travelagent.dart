...
class MakeTravelAgent extends StatefulWidget {
  @override
  _MakeTravelAgentState createState() => _MakeTravelAgentState();
}

class _MakeTravelAgentState extends State<MakeTravelAgent> {
